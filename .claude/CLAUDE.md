...
3. 工地工作人員: 除表單之外, 也需管理工作人員, 工作人員在執行工作類別的時候，需要具備相關的工作證照。工作人員沒有系統登錄的帳號, 但是在工地表單中會需要工作人員來簽名。所以簽名表單的畫面是不需要登入的, 但是在簽名的時候需要驗證工作人員的手機或者是身份證號碼。
4. 工地進度: 可以從XML或者是CSV匯入專案進度, 使用者可以在畫面上更新每日的工作進度。
5. 照片: 可以上傳工地照片, 並且給與不同的標籤來進行管理。
