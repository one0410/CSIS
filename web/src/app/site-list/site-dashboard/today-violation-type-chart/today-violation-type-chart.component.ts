...
@Component({
  selector: 'app-today-violation-type-chart',
  imports: [],
  templateUrl: './today-violation-type-chart.component.html',
  styleUrl: './today-violation-type-chart.component.scss'
})
export class TodayViolationTypeChartComponent implements OnInit, OnChanges, AfterViewInit {
  @Input() siteId: string = '';
  ...
  async loadChartData(): Promise<void> {
    ...
    try {
      ...
      console.error('載入今日違規種類圖表資料失敗:', error);
    }
  }
