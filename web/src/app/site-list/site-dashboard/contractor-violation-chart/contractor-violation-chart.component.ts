...
@Component({
  selector: 'app-contractor-violation-chart',
  imports: [],
  templateUrl: './contractor-violation-chart.component.html',
  styleUrl: './contractor-violation-chart.component.scss'
})
export class ContractorViolationChartComponent implements OnInit, OnChanges, AfterViewInit {
  @Input() siteId: string = '';
  ...
  async loadChartData(): Promise<void> {
    ...
    try {
      ...
      console.error('載入供應商違規次數圖表資料失敗:', error);
    }
  }
